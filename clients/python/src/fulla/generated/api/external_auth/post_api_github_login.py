...
from ...models.post_api_github_login_body import PostApiGithubLoginBody
...
def _get_kwargs(
    *,
    body: PostApiGithubLoginBody | Unset = UNSET,
    code: str,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        code (str):
        body (PostApiGithubLoginBody | Unset): Optional empty body (action-style operation).
