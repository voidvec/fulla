...
const std::string &expectedFingerprint()
{
    ...
    static const std::string kFingerprint =
      ...
      "DELETE /api/me/organizations/{slug}/consent-requests/{requestId}\n"
      ...
      "GET /api/me/organizations/{slug}/consent-requests\n"
      ...
      "POST /api/me/organizations/{slug}/consent-requests\n"
      "POST /api/me/organizations/{slug}/consent-requests/{requestId}/approve\n"
      "POST /api/me/organizations/{slug}/consent-requests/{requestId}/reject\n"
      "POST /api/me/organizations/{slug}/invitations\n"
      "POST /api/me/organizations/{slug}/successor-nomination\n"
