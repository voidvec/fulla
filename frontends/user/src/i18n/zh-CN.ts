...
export default {
  ...
  account: {
    ...
    applications: {
      title: '我的应用',
      intro: '您注册的应用，用于 OIDC 登录接入或 API 自动化。',
      loadFailed: '加载应用失败',
      emptyTitle: '还没有应用',
      emptyDesc: '注册一个应用，让您的软件用 Fulla 登录。',
      create: '注册应用',
      name: '应用名称',
      clientType: '客户端类型',
      redirectUris: '回调 URI（https，逗号或空格分隔）',
      redirectUrisPlaceholder: 'https://my-app.example/callback',
      scopes: '作用域（空格分隔，限自助白名单内）',
      submit: '注册',
      clientId: '客户端 ID：',
      rotate: '轮换密钥',
      delete: '删除',
      ...
      rotated: '已轮换“{app}”的密钥',
      deleted: '应用“{app}”已删除',
      rotateConfirm: '确定轮换“{app}”的密钥？旧密钥将立即失效。',
    ...
    organizations: {
      title: '我的组织',
      intro: '您创建或加入的组织；可邀请成员并管理成员关系。',
      loadFailed: '加载组织失败',
      emptyTitle: '暂无组织',
      emptyDesc: '创建一个组织，与团队共同管理应用。',
      create: '创建组织',
      slug: 'Slug（小写字母、数字、连字符）',
      name: '组织名称',
      submit: '创建',
      members: '成员',
      remove: '移除',
      removeConfirm: '确定将该成员移出组织？',
      inviteEmail: '被邀人邮箱',
      invite: '邀请',
      inviteToken: '邀请令牌（请交给被邀人）',
      invited: '邀请已创建',
      acceptTitle: '接受邀请',
      acceptPlaceholder: '邀请令牌',
      accept: '接受',
      accepted: '已接受邀请，欢迎加入！',
      created: '组织已创建',
      consents: '组织授权',
